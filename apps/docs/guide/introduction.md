...
- **Automatic query scoping** through thin ORM adapters — [Prisma](/guide/prisma) and [TypeORM](/guide/typeorm), same guarantees.
...
Tenantry is in **pre-release** (v1 — Prisma and TypeORM). The API documented here reflects the code on `main`. Follow the [roadmap](https://github.com/gettenantry/tenantry/blob/main/ROADMAP.md).
